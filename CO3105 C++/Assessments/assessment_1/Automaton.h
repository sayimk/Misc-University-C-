...
public : 
	...
	//My own custom get methods
	State* customGetState(int);
	State* customGetState(int) const;

	Transition* customGetTransition(int);
	Transition* customGetTransition(int) const;
...
private:
	...
	std::string _automatonName;
	State** _stateArray;
	Transition** _transitionArray;
	int _stateArraySize;
	int _transitionArraySize;
};
